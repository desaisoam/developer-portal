...
export const PeriodSelector = (props: {
  ...
  <Select value={props.timePeriod} onChange={props.onTimePeriodChange}>
    <SelectButton
      ...
      className="flex h-10 items-center justify-center gap-2 rounded-8 border border-portal-border bg-white py-2.5 pl-4 pr-3 font-world text-13 leading-none text-portal-ink outline-none transition-colors hover:bg-portal-canvas focus-visible:ring-2 focus-visible:ring-grey-300"
    >
      <span>
